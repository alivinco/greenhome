...
func (m *JWTMiddleware) GinRequestHandler () gin.HandlerFunc {
	return func(c *gin.Context) {
		// Let secure process the request. If it returns an error,
		// that indicates the request should not continue.
		err := m.CheckJWT(c.Writer, c.Request ,c)
...
func (m *JWTMiddleware) CheckJWT(w http.ResponseWriter, r *http.Request ,ginContext *gin.Context) error {
	...
	if ginContext != nil {
		ginContext.Set("jwt_token",parsedToken)
	} else {
